/*
  ...
  1. Changes
     - Creates a proper venue_interactions table with correct schema
     - Ensures compatibility with both anonymous and authenticated users
     - Sets up appropriate RLS policies
     - Adds necessary indexes for performance

  2. Security
     - Enables RLS on the table
     - Creates policies for both anonymous and authenticated users
