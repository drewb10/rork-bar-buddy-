/*
  # Fix Authentication System Schema

  1. New Tables
    - `profiles` - User profiles with username, email, and stats
...
DROP POLICY IF EXISTS "Users can insert their own friendships" ON friends;
